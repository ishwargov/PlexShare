...
namespace PlexShareTests.DashboardTests.Telemetry
{
    public class TelemetryTests
    {
        ...
        public void  GetUserIdVsChatCount_Test()
        {
            ...
            PlexShareContent.DataModels.ReceiveContentData message2 = new PlexShareContent.DataModels.ReceiveContentData();
            message2.Data = "Another Hello from user 1";
            message2.SenderID = 1;


            PlexShareContent.DataModels.ReceiveContentData message3 = new PlexShareContent.DataModels.ReceiveContentData();
            ...
            var msgList1 = new List<PlexShareContent.DataModels.ReceiveContentData>();
            ...
            var chat2 = new PlexShareContent.DataModels.ChatThread();
