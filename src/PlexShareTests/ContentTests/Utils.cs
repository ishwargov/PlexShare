...
namespace PlexShareTests.ContentTests
{
    public class Utils
    {
            ...
            string msg = "Hello", int[] rcvIds = null, int replyId = -1, MessageType type = MessageType.Chat)
        {
            ...
            var msgData = contentChatClient.ConvertSendContentData(sampleData, chatEvent);
            return msgData;
        }

        public ContentData GenerateNewMessageData(string Message, int MessageID = 1, int[] rcvIds = null,
        ...
        public ReceiveContentData GenerateNewReceiveMessageData(string Message, int MessageID = 1, int[] rcvIds = null,
            int ReplyThreadID = -1, int SenderID = -1, bool Starred = false, MessageType Type = MessageType.Chat)
        {
            if (rcvIds == null) rcvIds = new int[0];
            var msg = new ReceiveContentData();
        ...
        public ContentData GetContentData1()
        {
            ...
            var msgData = conch.ConvertSendContentData(sampleData, MessageEvent.New);
            return msgData;
        }
